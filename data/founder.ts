export const FOUNDER = {
  ...
  paragraphs: [
    "When I established Alamdaar Engineering Concern more than 30 years ago, it was with a firm belief that quality, reliability, and client trust are the cornerstones of a successful engineering business.",
    ...
    "Our commitment remains unchanged: to deliver dependable, high-quality products backed by exceptional service. Every partnership we build is founded on integrity, precision, and a shared vision for project success.",
  ],
} as const;
