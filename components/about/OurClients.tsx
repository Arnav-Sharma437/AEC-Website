      ...
      <article className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <ul className="grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-6">
          {clients.map((client) => (
            <li
              key={client.id}
              className="flex aspect-square flex-col items-center justify-center rounded-lg border border-border bg-surface p-4 grayscale transition hover:grayscale-0 dark:bg-card"
            >
