...
export default function ProductCard({ product, compact }: ProductCardProps) {
    ...
    return (
      <article className="overflow-hidden rounded-lg border border-border bg-white shadow-sm transition hover:shadow-md">
        ...
        <section className="p-4">
          ...
          <h3 className="mb-3 font-display text-base font-semibold text-primary">
            {product.name}
          </h3>
          <WhatsAppButton
  ...
  return (
    <article className="flex flex-col overflow-hidden rounded-lg border border-border bg-white shadow-sm transition hover:shadow-md md:flex-row">
